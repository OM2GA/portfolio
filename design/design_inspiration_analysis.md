...
- **Points d'attention pour Maxence** :
  - _Accessibilité & Performance_ : Ce type de site est lourd à charger sur mobile et difficile à naviguer pour un recruteur pressé (RH).
  - _Solution MMI_ : Garder le concept d'interaction ludique pour une section dédiée ou un mini-jeu optionnel, mais conserver une structure globale accessible et rapide.
...
- **Typographie** : Utilisation de polices hybrides. Une police _Sans-Serif géométrique_ et moderne pour les grands titres (ex: **Outfit** ou **Clash Display**) et une police _Monospace_ (ex: **Fira Code** ou **JetBrains Mono**) pour styliser les éléments de code ou les métadonnées de projets.
...
_Fin de l'analyse — Ce document fait foi pour l'implémentation de la charte graphique et de la structure du portfolio._
