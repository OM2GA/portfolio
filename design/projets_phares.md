...
```mermaid
graph TD
    P1["🏃 1. Les 20 Bornes d'Andrésy<br>(Projet Personnel - Adopté par la Mairie)"]
    P2["🍣 2. Oishi - Sushi Shop<br>(SAÉ Universitaire - Angular / PHP API)"]
    P3["⚽ 3. Decathlon Profiler<br>(Hackathon Nuit de l'Info - 2h Chrono)"]
    P4["🤸 4. Les Coulisses de la Gym<br>(SAÉ Universitaire - Webdoc & Multimédia)"]
```
...
*   **Les Résultats concrets (Soft Skills & Impact)** :
    ...
    *   **Respect de l'Identité de Marque** : Intégration impeccable du bleu Decathlon et de la police *Roboto Condensed* pour une immersion totale.
